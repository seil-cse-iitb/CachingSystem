...
public class BitmapOld {
    ...
    public BitmapOld(List<String> sensorIds, String granularity) {
    ...
    public ArrayList<QueryOld.TimeRange> getNonExistingDataRange(String sensorId, QueryOld.TimeRange timeRange) throws Exception {
        ...
        ArrayList<QueryOld.TimeRange> nonExistingTimeRanges = new ArrayList<>();
        ...
        while (progressI < endI) {
            ...
            nonExistingTimeRanges.add(new QueryOld.TimeRange(clearBitI + this.startTime, setBitI + this.startTime));
            progressI = setBitI;
        }
        return nonExistingTimeRanges;
    }

    public void updateBitmap(QueryOld queryOld, String sensorId, ArrayList<QueryOld.TimeRange> timeRanges) {
        BitmapEntryBean bitmapEntry = bitmapEntries.get(sensorId);
