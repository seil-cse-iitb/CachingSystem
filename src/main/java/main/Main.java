...
//    SELECT FLOOR(TS) as time_sec, power as value,'power_sensor' as metric, 'from_cache' as meta_data FROM power WHERE   TS >= 1514745000 AND TS <= 1514831400 and sensor_id ='power_k_seil_p' and granularity like '1 hour' order by time_sec
    ...
    public static List<QueryBean> getNewQueries() {
        ...
        zoomOutQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 1325356200 AND TS <= 1325442600 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomOutQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 946751400 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomOutQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 946837800 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomOutQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 947010600 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomOutQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 947356200 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomOutQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 948047400 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomOutQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 949429800 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomOutQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 952194600 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomOutQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 957724200 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomOutQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 968783400 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomOutQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 990901800 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomOutQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 1035138600 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomOutQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 1123612200 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomOutQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 1300559400 and sensor_id ='power_k_sr_a' order by time_sec");

        ArrayList<String> zoomInQueries = new ArrayList<>();
        zoomInQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 1325356200 AND TS <= 1325442600 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomInQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 1300559400 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomInQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 1123612200 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomInQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 1035138600 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomInQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 990901800 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomInQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 968783400 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomInQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 957724200 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomInQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 952194600 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomInQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 949429800 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomInQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 948047400 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomInQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 947356200 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomInQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 947010600 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomInQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 946837800 and sensor_id ='power_k_sr_a' order by time_sec");
        zoomInQueries.add("SELECT FLOOR(TS) as time_sec, power as value,'power_k_sr_a' as metric, 'from_cache' as meta_data FROM power WHERE TS >= 946665000 AND TS <= 946751400 and sensor_id ='power_k_sr_a' order by time_sec");
